...
func recur(previous [][]int, n int) (plateau [][][]int) { //je ne peux pas utiliser de "vrai" fonction récurcive car sinon il y'a un overflow a partir de n = 9
